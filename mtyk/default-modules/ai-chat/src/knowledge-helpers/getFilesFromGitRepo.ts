...
export async function getFileFromGitRepo(repoPath: string, repoRelativePath: string) {
	...
	const sourceFile = ts.createSourceFile(repoRelativePath, contents, ts.ScriptTarget.Latest, true)
